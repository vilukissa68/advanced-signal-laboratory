...
In this project we familiarized ourselves with the basics of holographic display, by implementing a part of a holograpics display viewing simulation.
...
Our implementation of the holographic image viewer included 3 different methods of holographic image synthesis, one of which was provided in the code base given to us. The ready made synthesis method was holographic stereograph synthesis, which [TODO: explain hss here]. The first synthesis method we implemented was a Fresnel hologram syntheis which, [TODO: explain Fresnel here]. The second method we implemented was Rayleigh-Sommerfeld synthesis which, [TODO. explain RSS here].
